# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-13 22:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specimen_identifier', models.CharField(editable=False, max_length=50, verbose_name='Specimen Id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('f1', models.CharField(default='erik', max_length=10)),
                ('crf_one', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='edc_example.CrfOne')),
            ],
        ),
        migrations.CreateModel(
            name='CrfSix',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specimen_collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='edc_example.SpecimenCollection')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='edc_example.Appointment')),
            ],
        ),
        migrations.AddField(
            model_name='subjectrequisition',
            name='subject_visit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='edc_example.SubjectVisit'),
        ),
        ...
        migrations.AddField(
            model_name='crftwo',
            name='subject_visit',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='edc_example.SubjectVisit'),
        ),
        migrations.AddField(
            model_name='crfthree',
            name='subject_visit',
        ...
        migrations.AddField(
            ...
            name='other_model',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='edc_example.OtherModel'),
        ),
        migrations.AddField(
            model_name='crfone',
            name='subject_visit',
        ...
        migrations.AddField(
            ...
            name='crf_one',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='edc_example.CrfOne'),
        ),
        migrations.AddField(
            model_name='badcrfoneinline',
            name='other_model',
